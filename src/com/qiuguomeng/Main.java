...
//        instance.mkDir();//4
    ...
    private void read() {
        CommandBeans commandBeans = new CommandBeans(InteractionSocket.READ_TYPE,  "C:\\0101", this);
        ThreadUtil.getInstance().setTask(5,commandBeans);
    }

    private void mkDir() {
        CommandBeans commandBeans = new CommandBeans(InteractionSocket.MKDIR_TYPE,  "C:\\0101\\010101", this);
        ThreadUtil.getInstance().setTask(4,commandBeans);
    }

    private void delete() {
        CommandBeans commandBeans = new CommandBeans(InteractionSocket.DELETE_TYPE,  "C:\\0101\\0202.txt", this);
        ThreadUtil.getInstance().setTask(3,commandBeans);
    }

    private void pull() {
        CommandBeans commandBeans = new CommandBeans(InteractionSocket.PULL_TYPE,  "C:\\0101\\0202.txt","D:\\0102\\0203.txt", this);
        ThreadUtil.getInstance().setTask(2,commandBeans);
    }

    private void push() {
        CommandBeans commandBeans = new CommandBeans(InteractionSocket.PUSH_TYPE, "D:\\0102\\0202.txt", "C:\\0101\\0202.txt", this);
